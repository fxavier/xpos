package com.mz.xpos.dao.filter;
...
public class FacturaFilter implements Serializable {
	...
	private StatusFactura[] statuses;
	...
	public void setStatuses(StatusFactura[] statuses) {
